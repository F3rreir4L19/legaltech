...
class Anotacao(models.Model):
    ...
    # Controle
    importante = models.BooleanField(_('Importante'), default=False)
    privada = models.BooleanField(_('Privada'), default=False, 
                                  help_text=_('Somente o usuário criador pode visualizar'))
    
    # Datas
    data_referencia = models.DateField(_('Data de Referência'), null=True, blank=True)
    lembrar_em = models.DateTimeField(_('Lembrar em'), null=True, blank=True)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['usuario', 'importante']),
        ]
    ...
    def resumo(self):
        """Resumo do conteúdo"""
        return self.conteudo[:100] + '...' if len(self.conteudo) > 100 else self.conteudo
