...
class Financeiro(models.Model):
    ...
    def valor_pendente(self):
        ...
        return valor - valor_pago
    
    @property
    def percentual_pago(self):
        """Calcula percentual pago"""
        if self.valor == 0 or self.valor is None:
            return 100
    ...
    def esta_vencido(self):
        ...
        if self.data_vencimento is None:
            return False  # Ou True se fizer sentido no seu contexto, mas False é mais seguro pra itens novos
        return (
