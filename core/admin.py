...
class AnotacaoAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context = None):
        return HttpResponseRedirect("anotacoes/")
...
class MensagemWhatsAppAdmin(admin.ModelAdmin):
    verbose_name = "WhatsApp"  # Mantenha ou mude
    verbose_name_plural = "WhatsApp"

    def changelist_view(self, request, extra_context=None):
        return HttpResponseRedirect('/api/whatsapp/painel/')
...
class ConversaWhatsAppAdmin(admin.ModelAdmin):
    ...
    admin_site.register(Escritorio, EscritorioAdmin)
admin_site.register(Usuario, UsuarioAdmin)
admin_site.register(Cliente, ClienteAdmin)
admin_site.register(Anotacao, AnotacaoAdmin)
admin_site.register(Entrevista, EntrevistaAdmin)
admin_site.register(Processo, ProcessoAdmin)
admin_site.register(Andamento, AndamentoAdmin)
admin_site.register(Prazo, PrazoAdmin)
admin_site.register(Audiencia, AudienciaAdmin)
admin_site.register(Financeiro, FinanceiroAdmin)
admin_site.register(ContratoHonorarios, ContratoHonorariosAdmin)
admin_site.register(ParcelaHonorarios, ParcelaHonorariosAdmin)
admin_site.register(WhatsAppConfig, WhatsAppConfigAdmin)
admin_site.register(MensagemWhatsApp, MensagemWhatsAppAdmin)
admin_site.register(FluxoChatbot, FluxoChatbotAdmin)
admin_site.register(ConversaWhatsApp, ConversaWhatsAppAdmin)